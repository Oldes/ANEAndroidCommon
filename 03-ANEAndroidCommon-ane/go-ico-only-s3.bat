...
xcopy /S /Y res-s3\* src\assets\platform\Android-ARM\
::xcopy /S /Y res-s3\* src\assets\platform\Android-x86\
...
::uncomment for S3 adaptive icon assets
xcopy /S /Y res-icon-s3 src\assets\platform\Android-ARM\
::xcopy /S /Y res-icon-s3 src\assets\platform\Android-x86\
...
java -jar "%AIR_SDK%\lib\adt.jar" -package                     ^
	-target ane ANEAndroidCommon-s3-noSupport.ane src\extension.xml    ^
