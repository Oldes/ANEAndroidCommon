...
SET AIR_SDK_64=..\..\AIRSDK-Windows-Harman
SET PASS=none
SET PAUSE_ERRORS=1
SET ARCH_OPTION=arm8
SET EXTENSIONS_DIR=../release/ARM64-Support-v27/Samorost3/
...
set BUILD_NAME=Build\TestAndroidCommon-ARM64.apk
...
@echo on
java -jar %AIR_SDK_64%\lib\adt.jar -package -target apk-debug -arch %ARCH_OPTION% ^
